...
if($string == 'Food_products')
{

$query = "select * from Food_products where Product_id = '$string2'";
...
$query2 = "select * from Other_products where Product_id = '$string2'";
...
$query = "select * from Food_products where ProductType = '$string3' and Product_id not in(select Product_id from Food_products where Product_id = '$string2')";
...
$query2 = "select * from Other_products where ProductType = '$string3' and Product_id not in(select Product_id from Other_products where Product_id = '$string2')";
